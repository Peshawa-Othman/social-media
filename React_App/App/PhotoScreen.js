        ...
        renderItem={({ item }) => (
          <View>
            ...
            >
              ...
              {item.Subject && <Text style={styles.name}>{item.Name}</Text>}
            </View>
            <View
              style={{
                alignItems: "center",
            ...
            >
              {item.Subject && <Text style={styles.text}>{item.Text}</Text>}
            </View>
            <View
              style={{
                alignItems: "center",
            ...
            >
              {item.Subject && (
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate("BigSubject", { Subject: item.Subject })
                  }
                >
